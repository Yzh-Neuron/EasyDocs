...
&emsp;按提示设置密钥保存路径（默认 ~/.ssh/id_ed25519）和密码短语（可留空，一直按Enter键）。在C:/Users/ <__你的电脑用户名__> /.ssh 目录下会生成以下两个文件：<br>
- 私钥：id_ed25519（自己保存，切勿泄露）<br>
- ==公钥：id_ed25519.pub（需添加到 Git 服务器）==
...
&emsp;若看到类似 Hi username! You've successfully authenticated... 的提示，说明连接正常。
